        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            ...
            <section class="panel panel-padding">
                <div class="group-button">
                    ...
                    <button class="layui-btn layui-btn-small modal" data-params='{"content":".add-subcat","area":"500px,auto", "title":"添加","type":"1","dataName":"<?=$generator->controllerID?>","key":"<?=$pks?>","action":"add","url":"<?='<?=\yii\helpers\Url::toRoute("'.$generator->controllerID.'/add")?>'?>"}'>
    ...
    <tr>
            ...
            foreach ($generator->getColumnNames() as $attribute) {
                if(isset($giishow['table'][$attribute]['show_mode']) &&$giishow['table'][$attribute]['show_mode']!="不展示") {
                        if($giishow['table'][$attribute]['show_mode']=="开关")
                        {
                            ...
                            echo '<td><div class="img"><img src="{{ item.'.$attribute.'?item.'.$attribute.':\'admin/images/avatar.png\'}}" alt="..." class="img-thumbnail"></div></td>'."\n";
        ...
        <td style="text-align: center">
            ...
            <div class="layui-btn-group">
                <button class="layui-btn layui-btn-mini modal" data-params='{"content": ".add-subcat","area":"520px,auto","title":"编辑","data":"<?=$pks?>={{item.<?=$pks?>}}","type":"1","action":"edit","bind":true,"url":"<?='<?=\yii\helpers\Url::toRoute("'.$generator->controllerID.'/update")?>'?>"}'>
