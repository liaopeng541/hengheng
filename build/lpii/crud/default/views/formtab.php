...
<div class="container-fluid ">
    <form id="form1" style="background: #ffffff;padding-bottom: 20px" class="layui-form layui-form-pane"
          data-params='{"dataName":"lp-goods","key":"goods_id",<? if (isset($_GET["goods_id"])) { ?>"action":"edit","bind":true<? } else { ?>"action":"add"<? } ?>}'
          action="<?= isset($_GET["goods_id"]) ? \yii\helpers\Url::toRoute("lp-goods/update") : \yii\helpers\Url::toRoute("lp-goods/add") ?>"
          method="POST">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="padding: 0px;margin: 0 auto; text-align: center">
                <? if (isset($_GET["goods_id"])) { ?>
                    <button class="layui-btn" jq-tab="true" jq-submit jq-filter="submit" lp-sub>保存修改</button>
