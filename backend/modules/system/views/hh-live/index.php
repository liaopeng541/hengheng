...
<div class="lp-grid">
    <div class="lp-table-top">
        <div class="layui-btn-group">
                        ...
                        lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-live/add")?>',type:2,maxmin:true,area: ['893px', '600px'],title:'添加' }"
                        style="background: #2980B9"><i class="layui-icon"></i>添加
                </button>
                                        <button class="layui-btn layui-btn-sm layui-btn-danger lp-all-del"
                        lp-data="{table:'hh-live',key:'id',url:'<?=\yii\helpers\Url::toRoute("hh-live/delete")?>'}"
                ...
                <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input class="layui-input" name="device" placeholder="设备号" />
                            </div>
                        </div>
                        <div class="layui-inline">
                            
                            <div class="layui-input-inline">
                                <select name="work_id" placeholder="工位">
                ...
                <div class="layui-input-inline">
                    <button lay-submit lp-table="hh-live" lay-filter="search"
                            class="layui-btn layui-btn-sm layui-btn-default"><i
                                class="layui-icon">&#xe615;</i>搜索
                    </button>
                    <div lp-reset-mini-search lp-table="hh-live"
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-live-filter"
               lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-live/index")?>','id':'hh-live'}">
            <thead>
            <tr>
                <th lay-data="{type:'checkbox'}"></th>
                                        <th lay-data="{field:'id',sort: true}">ID</th>

                                                <th lay-data="{field:'work_id',sort: true,templet:'#work_idTpl'}">工位</th>

                                                <th lay-data="{field:'device'}">设备号</th>

                                                <th lay-data="{field:'crame'}">摄像头</th>
...
<script src="admin/src/layui.js"></script>
                    ...
                    <script type="text/html" id="work_idTpl">
                <div class="lp-col-detail" lay-event="show_detail"
                     lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("hh-work-station/detail")?>',area: ['893px', '600px'],title:'详情',key:'work_id'}">
                    {{ d.work_id_lp }}
                </div>
            </script>
    ...
    <script type="text/html" id="barDemo">
                    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-live/detail")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'详情'}"
               class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
                <i class="layui-icon">&#xe60a;</i> 查看
            </a>
                            <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-live/update")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'编辑'}"
               class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
            </a>
                            <a lp-data="{table:'hh-live',key:'id',url:'<?=\yii\helpers\Url::toRoute("hh-live/delete")?>'}"
