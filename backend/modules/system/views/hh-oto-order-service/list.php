...
<div class="lp-grid">
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-oto-order-service-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-oto-order-service/index")?>','id':'hh-oto-order-service'}">
            <thead>
            <tr>
                <th lay-data="{type:'checkbox'}"></th>
                                        <th lay-data="{field:'id',sort: true}">ID</th>

                                                <th lay-data="{field:'service_id',sort: true,templet:'#service_idTpl'}">服务名称</th>
...
<script src="admin/src/layui.js"></script>
                ...
                <div class="lp-col-detail" lay-event="show_detail" lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("hh-worker/detail")?>',area: ['893px', '600px'],title:'详情',key:'worker_id'}" >
                    {{ d.worker_id_lp }}
                </div>
            </script>
