...
<div class="lp-grid">
    <div class="lp-table-top">
        <div class="layui-btn-group">
                ...
                <div class="layui-input-inline">
                    <button lay-submit lp-table="lp-brand" lay-filter="search"
                            class="layui-btn layui-btn-sm layui-btn-default"><i
                                class="layui-icon">&#xe615;</i>搜索
                    </button>
                    <div lp-reset-mini-search lp-table="lp-brand"
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="lp-brand-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("lp-brand/index")?>','id':'lp-brand'}">
            <thead>
            <tr>
                ...
                <div class="layui-body lp-search-body">
                    <form class="layui-form layui-form-pane" action="#" style="padding: 5px">
                        ...
                        <button style="display: none" lp-table="lp-brand" lay-submit lay-filter="search"
...
<script src="admin/src/layui.js"></script>
            ...
            <script type="text/html" id="logoTpl">
                <div class="lp-col-center ">
                    <div {{# if(d.logo){}}class="lp-zoom"{{# }}}>
                        <img src="{{# if(d.logo){}}{{d.logo}}{{# }else{}}admin/images/avatar.png{{# }}}" jqimg="{{# if(d.logo){}}{{d.logo}}{{# }else{}}admin/images/avatar.png{{# }}}" {{# if(d.logo){}} class="lp-img" {{# }}}>
                    </div>
                </div>
            </script>
                            <script type="text/html" id="cat_idTpl">
                <div class="lp-col-detail" lay-event="show_detail" lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("lp-goods-category/detail")?>',area: ['893px', '600px'],title:'详情',key:'cat_id'}" >
                    {{ d.cat_id_lp }}
                </div>
            </script>
            ...
            <script type="text/html" id="is_hotTpl">
                <div class="lp-col-center ">
                    <input type="checkbox" lp-data="{url:'<?=\yii\helpers\Url::toRoute("lp-brand/setstatus")?>',id:{{d.id}},on:'1',off:'0',key:'id',table:'lp-brand'}" name="is_hot" lay-skin="switch" lay-filter="lp-brand"  title="开关" lay-text="启用|禁用">
                </div>
            </script>

        
    <script type="text/html" id="barDemo">
                    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-brand/detail")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'详情'}"  class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
                <i class="layui-icon">&#xe60a;</i> 查看
            </a>
                            <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-brand/update")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'编辑'}" class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
            </a>
