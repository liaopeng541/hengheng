...
<div class="lp-center-box-main">
    <div class="lp-grid">
        <div class="lp-table-top">
            <div class="layui-btn-group">
                <button class="layui-btn layui-btn-sm  lp-drop-table"
                        lp-data="{'width':'500px','height':'300px','o':'bottom','url':'/build/web/index.php?r=shop%2Flp-goods%2Fselect-table'}"
        ...
        <div class="c-c-box">
            ...
            <table class="layui-table" lay-filter="demob"
                   lay-data="{cellMinWidth: 80,height:'full-340', page: true,sort:'server', limit:30, url:'/build/web/index.php?r=build%2Flp-users%2Findex','id':'user'}">
                <thead>
                <tr>
    ...
    <div class="c-b-box">
        <div class="layui-tab layui-tab-brief" lay-filter="lp-tow-bottom" style="width: 100%;height: 100%;margin: 0px">
            <ul class="layui-tab-title">
                <li lp-data="{url:'/build/web/index.php?r=shop%2Flp-goods%2Fselect-table'}" class="layui-this">车辆</li>
                <li lp-data="{url:'/build/web/index.php?r=shop%2Flp-goods%2Fselect-table'}">后备箱</li>
                <li lp-data="{url:'/build/web/index.php?r=shop%2Flp-goods%2Fselect-table'}">门店订单</li>
                <li lp-data="{url:'/build/web/index.php?r=shop%2Flp-goods%2Fselect-table'}">商城订单</li>
    ...
    box-sizing: border-box;">
                    ...
                    <iframe  frameborder="0" name="content" scrolling="no" width="100%"  height="100%" src="/build/web/index.php?r=shop%2Flp-goods%2Fselect-table"></iframe>
