...
<div class="container-fluid " style="padding:10px">
    <form class="layui-form layui-form-pane" action="<? if(isset($_GET["id"])){ echo \yii\helpers\Url::toRoute("hh-car-series/update");}else{echo \yii\helpers\Url::toRoute("hh-car-series/add");}?>" lp-data="{<?if(isset($_GET["id"])){?>type:'edit',key:'id',value:<?=$_GET["id"]?>,<?}?>table:'hh-car-series'}">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Initial</label>
            <div class="layui-input-block">
                <input class="layui-input" name="initial" required lay-verify="required" lay-error="Initial不能为空" placeholder="请输入Initial" />
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">Firms</label>
            <div class="layui-input-block">
                <input class="layui-input" name="firms" required lay-verify="required" lay-error="Firms不能为空" placeholder="请输入Firms" />
            </div>
        </div>
        <div class="layui-form-item">
