...
<div class="lp-grid">
    <div class="lp-table-top">
        <div class="layui-btn-group">
                ...
                <div class="layui-input-inline">
                    <button lay-submit lp-table="hh-car-series" lay-filter="search"
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-car-series-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-car-series/index")?>','id':'hh-car-series'}">
            <thead>
            <tr>
...
<script src="admin/src/layui.js"></script>
    ...
    <script type="text/html" id="barDemo">
                    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-car-series/detail")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'详情'}"  class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
                <i class="layui-icon">&#xe60a;</i> 查看
            </a>
                            <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-car-series/update")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'编辑'}" class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
            </a>
