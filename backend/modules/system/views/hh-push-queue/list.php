...
<option value="9">网页跳转</option>
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-push-queue-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-push-queue/index")?>','id':'hh-push-queue'}">
            <thead>
            <tr>
                <th lay-data="{type:'checkbox'}"></th>
                                        <th lay-data="{field:'id',sort: true}">ID</th>
                                                ...
                                                <th lay-data="{field:'goods_id'}">商品编号</th>
                                                ...
                                                <th lay-data="{field:'level_id'}">推送登陆</th>
