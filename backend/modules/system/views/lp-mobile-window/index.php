...
<div class="lp-grid">
    <div class="lp-table-top">
        <div class="layui-btn-group">
                        ...
                        lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/add")?>',type:2,maxmin:true,area: ['350px', '300px'],title:'添加' }"
                        style="background: #2980B9"><i class="layui-icon"></i>添加
                </button>
                                        <button class="layui-btn layui-btn-sm layui-btn-danger lp-all-del"
                        lp-data="{table:'lp-mobile-window',key:'id',url:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/delete")?>'}"
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="lp-mobile-window-filter"
               lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/index")?>','id':'lp-mobile-window'}">
            <thead>
            <tr>
...
<script type="text/html" id="barDemo">
    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/detail")?>',key:'id',type:2,maxmin:true,area: ['350px', '300px'],title:'详情'}"
       class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
        <i class="layui-icon">&#xe60a;</i> 查看
    </a>
    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/update")?>',key:'id',type:2,maxmin:true,area: ['350px', '300px'],title:'编辑'}"
       class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
    </a>
    <a lp-data="{table:'lp-mobile-window',key:'id',url:'<?=\yii\helpers\Url::toRoute("lp-mobile-window/delete")?>'}"
