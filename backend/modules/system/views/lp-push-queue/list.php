...
<div class="lp-grid">
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="lp-push-queue-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("lp-push-queue/index")?>','id':'lp-push-queue'}">
            <thead>
            <tr>
            ...
            <script type="text/html" id="imgTpl">
                <div class="lp-col-center ">
                    <div {{# if(d.img){}}class="lp-zoom"{{# }}}>
                        <img src="{{# if(d.img){}}{{d.img}}{{# }else{}}admin/images/avatar.png{{# }}}" jqimg="{{# if(d.img){}}{{d.img}}{{# }else{}}admin/images/avatar.png{{# }}}" {{# if(d.img){}} class="lp-img" {{# }}}>
                    </div>
                </div>
            </script>
