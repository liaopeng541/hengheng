...
<div class="lp-grid">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <select name="user_id" placeholder="用户名">
                        ...
                        <? foreach ($admin_user_admin_id as $key=>$val){echo '<option value="'.$key.'">'.$val.'</option>';}?>
                    </select>
                </div>
            </div>
            <div class="layui-inline">    
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="admin-log-filter"
               lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("admin-log/index")?>','id':'admin-log'}">
            <thead>
            <tr>
...
<script type="text/html" id="user_idTpl">
    <div class="lp-col-center"
         lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("admin-user/detail")?>',area: ['550px', '400px'],title:'详情',key:'user_id'}">
        {{ d.user_id_lp }}
    </div>
</script>
         
<script type="text/html" id="barDemo">
    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("admin-log/detail")?>',key:'id',type:2,maxmin:true,area: ['600px', '400px'],title:'详情'}"
