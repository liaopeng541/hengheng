...
<div class="lp-grid">
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-service-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-service/index")?>','id':'hh-service'}">
            <thead>
            <tr>
                <th lay-data="{type:'checkbox'}"></th>
                                        <th lay-data="{field:'id',sort: true}">ID</th>
                                                ...
                                                <th lay-data="{field:'price',sort: true}">Price</th>
                                    ...
                                    <? foreach ($hh_service_cat_id as $key=>$val)
                {
                    echo '<option value="'.$key.'">'.$val.'</option>';
                        ...
                        <button style="display: none" lp-table="hh-service" lay-submit lay-filter="search"
...
<script src="admin/src/layui.js"></script>
            ...
            <script type="text/html" id="thumbTpl">
                ...
                <div class="lp-col-detail" lay-event="show_detail" lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("hh-service-cat/detail")?>',area: ['893px', '600px'],title:'详情',key:'cat_id'}" >
                    {{ d.cat_id_lp }}
                </div>
            </script>
    ...
    <script type="text/html" id="barDemo">
                    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-service/detail")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'详情'}"  class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
                <i class="layui-icon">&#xe60a;</i> 查看
            </a>
                            <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("hh-service/update")?>',key:'id',type:2,maxmin:true,area: ['893px', '600px'],title:'编辑'}" class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
            </a>
                            <a lp-data="{table:'hh-service',key:'id',url:'<?=\yii\helpers\Url::toRoute("hh-service/delete")?>'}" class="layui-btn layui-btn-danger layui-btn-xs" lay-event="del"><i class="layui-icon">&#xe640;</i>删除
            </a>
            </script>
