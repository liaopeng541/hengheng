...
<option value="2">女</option>
    ...
    <div class="c-c-box">
        <table class="layui-table" lay-filter="lp-users-filter" lay-size="sm" lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("lp-users/index")?>','id':'lp-users'}">
            <thead>
            <tr>
...
<option value="2">女</option>
                        ...
                        <button style="display: none" lp-table="lp-users" lay-submit lay-filter="search"
...
<script src="admin/src/layui.js"></script>
                ...
                <div class="lp-col-detail" lay-event="show_detail" lp-data="{type:2,content:'<?=\yii\helpers\Url::toRoute("lp-user-level/detail")?>',area: ['893px', '600px'],title:'详情',key:'level'}" >
                    {{ d.level_lp }}
                </div>
            </script>
    ...
    <script type="text/html" id="barDemo">
                    <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-users/detail")?>',key:'user_id',type:2,maxmin:true,area: ['893px', '600px'],title:'详情'}"  class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">
                <i class="layui-icon">&#xe60a;</i> 查看
            </a>
                            <a lp-data="{content:'<?=\yii\helpers\Url::toRoute("lp-users/update")?>',key:'user_id',type:2,maxmin:true,area: ['893px', '600px'],title:'编辑'}" class="layui-btn layui-btn-xs" lay-event="edit"><i class="layui-icon">&#xe642;</i>编辑
            </a>
