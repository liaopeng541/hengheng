...
<div class="container-fluid " style="padding:10px">
    <form class="layui-form layui-form-pane" action="<? if(isset($_GET["id"])){ echo \yii\helpers\Url::toRoute("lp-users/update");}else{echo \yii\helpers\Url::toRoute("lp-users/add");}?>" lp-data="{<?if(isset($_GET["id"])){?>type:'edit',key:'user_id',value:<?=$_GET["id"]?>,<?}?>table:'lp-users'}">
