...
<div class="lp-grid">
    <div class="lp-table-top">
        ...
        <form class="layui-form lp-search-form" action="#">
            ...
            <div class="layui-input-inline">
                <button lay-submit lp-table="hh-oto-order-cancel" lay-filter="search" class="layui-btn layui-btn-sm layui-btn-default"><i class="layui-icon">&#xe615;</i>搜索
                </button>
                <div lp-reset-mini-search lp-table="hh-oto-order-cancel" class="layui-btn layui-btn-sm layui-btn-primary"><i class="layui-icon">&#xe639;</i>重置
                </div>
            </div>
        </form>
    </div>
    <div class="c-c-box">
        <table class="layui-table" lay-filter="hh-oto-order-cancel-filter"
               lay-data="{cellMinWidth: 80,height:'full-40', page: true,sort:'server', limit:30, url:'<?=\yii\helpers\Url::toRoute("hh-oto-order-cancel/index")?>','id':'hh-oto-order-cancel'}">
            <thead>
            <tr>
