...
<div class="container-fluid " style="padding:10px">
    <form class="layui-form layui-form-pane" action="<? if(isset($_GET["id"])){ echo \yii\helpers\Url::toRoute("hh-re-feedback/update");}else{echo \yii\helpers\Url::toRoute("hh-re-feedback/add");}?>" lp-data="{<?if(isset($_GET["id"])){?>type:'edit',key:'id',value:<?=$_GET["id"]?>,<?}?>table:'hh-re-feedback'}">
        <div class="layui-form-item">
            <label class="layui-form-label">问题</label>
            <div class="layui-input-block">
                <input class="layui-input" name="question" required lay-verify="required" lay-error="问题不能为空" placeholder="请输入问题" />
            </div>
        </div>
